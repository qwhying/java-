...
public class MineType {
    public static final int MINE_STATUS_OPEN_0=0;//周围8个各自中没有雷
    ...
    public static final int MINE_STATUS_OPEN_9=9;//自己是雷
    public static final int MINE_STATUS_BLANK=10;//默认各自图片
    public static final int MINE_STATUS_FLAG=11;//格子标记为棋子
    ...
    public static final int MINE_STATUS_MILE=15;//开始时，顶部图片图片
    public static final int MINE_STATUS_WAIT=16;//等待时，顶部按钮的图片
